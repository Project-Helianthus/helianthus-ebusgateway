...
func TestIssue819ReleasedDependencyClosurePinsEEBusregV0135(t *testing.T) {
	...
	if len(versions) != 1 || versions[0] != "v0.1.35" {
		t.Fatalf("%s versions = %v, want exactly [v0.1.35]", module, versions)
	}
}
