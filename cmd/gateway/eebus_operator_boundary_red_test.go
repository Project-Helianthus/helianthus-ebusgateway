...
func TestIssue745DependencyClosurePinsEEBusregV0116(t *testing.T) {
	...
	if len(versions) != 1 || versions[0] != "v0.1.16" {
		t.Fatalf("%s versions = %v, want exactly [v0.1.16]", module, versions)
	}
}
