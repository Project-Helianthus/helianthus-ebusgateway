...
func TestIssue819ReleasedDependencyClosurePinsEEBusregV0134(t *testing.T) {
	...
	if len(versions) != 1 || versions[0] != "v0.1.34" {
		t.Fatalf("%s versions = %v, want exactly [v0.1.34]", module, versions)
	}
}
