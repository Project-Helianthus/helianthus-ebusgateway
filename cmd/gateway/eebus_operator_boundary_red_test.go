...
func TestIssue782ReleasedDependencyClosurePinsEEBusregV0130(t *testing.T) {
	...
	if len(versions) != 1 || versions[0] != "v0.1.30" {
		t.Fatalf("%s versions = %v, want exactly [v0.1.30]", module, versions)
	}
}
