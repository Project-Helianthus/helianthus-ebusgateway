...
func TestIssue780ReleasedDependencyClosurePinsEEBusregV0129(t *testing.T) {
	...
	if len(versions) != 1 || versions[0] != "v0.1.29" {
		t.Fatalf("%s versions = %v, want exactly [v0.1.29]", module, versions)
	}
}
