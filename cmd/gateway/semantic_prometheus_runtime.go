...
func semanticPrometheusDomains(adapter *modbusadapter.Adapter, growatt *growattBMSRS485ProductionProvider, pvEnabled, storageEnabled bool, storageAsset string, at time.Time) []ebusgateway.SemanticMetricsDomain {
