...
func TestEEBusregV0116ModuleClosure(t *testing.T) {
...
func TestEEBusregV0116RuntimeAndGatewayBoundary(t *testing.T) {
...
func TestEEBusregV0116CandidateFlowStaysPrivate(t *testing.T) {
	forbidden := []string{
		"candidate_ref",
		"CandidateRef",
