...
func TestEEBusregV0115ModuleClosure(t *testing.T) {
...
func TestEEBusregV0115RuntimeAndGatewayBoundary(t *testing.T) {
...
func TestEEBusregV0115CandidateFlowStaysPrivate(t *testing.T) {
	forbidden := []string{
		"candidate_ref",
		"CandidateRef",
