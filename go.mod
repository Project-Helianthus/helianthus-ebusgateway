...
require (
	...
	github.com/Project-Helianthus/helianthus-eebusreg v0.1.28
...
require (
	github.com/Project-Helianthus/helianthus-eebus-go v0.7.1-helianthus.13 // indirect
	github.com/Project-Helianthus/helianthus-ship-go v0.6.1-helianthus.11 // indirect
	github.com/Project-Helianthus/helianthus-spine-go v0.7.1-helianthus.8 // indirect
